...
* Advertiser chooses tarfet demographic(s), users then exposed to treatement / control
...
* Displaying ad $\imples$ won an auction  $\implies$ exposed users are highly values (higher expected conversion probability)
...
* **RCTs are the gold standard for measuring ad effectiveness**
  ...
  * Significant for registratio and page views almost always
...
* Measuring (digital) Ad effects is **hard**, endogeneity is everywhere
  * RCTs/expriments are our the best way forward
